...
class Team(models.Model):
   ...
   checkin_charge_1 = models.CharField(max_length=100, verbose_name="担当者名",null=True, blank=True)
   file_stage = models.FileField(upload_to='website_app/files/',null=True, blank=True, verbose_name='添付ファイル')
